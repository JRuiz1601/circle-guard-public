"""
Carga / estrés contra servicios locales (p. ej. kubectl port-forward).
Usuarios sembrados: health_user / password (auth Flyway).

Ejemplo:
  locust -f locustfile.py --headless -u 10 -r 2 -t 60s

Hosts por defecto alineados con CircleGuardE2ETest (8081–8085).
"""
